  ...
  <div className="min-h-screen pt-32 pb-20 px-6 max-w-7xl mx-auto">
    <div className="grid lg:grid-cols-2 gap-20 items-center">
      ...
      >
        ...
        <Link 
          to="/gallery" 
          className="inline-block px-8 py-4 bg-white text-black rounded-full font-semibold uppercase text-xs tracking-widest hover:scale-105 transition-transform"
        >
          Смотреть фото
        </Link>
      </motion.div>
  ...
  return (
    <div className="min-h-screen pt-32 pb-20 px-6 max-w-7xl mx-auto">
      <div className="flex justify-between items-end mb-16">
        ...
        <p className="text-gray-400 text-sm max-w-[200px] text-right">
      ...
      {photos.length === 0 ? (
        <div className="text-center py-40 border border-dashed border-white/10 rounded-3xl">
          <ImageIcon className="mx-auto mb-4 opacity-20 text-white" size={48} />
